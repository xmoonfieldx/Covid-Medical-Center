...
<body>
  ...
  <br/>
  <form id = "login" action = "http://localhost/details_answer.php" method = "post">
    <div class = "usualDiv">
      <table style="margin-top:65px;">
         <tr>
           <td style="font-size: 150%; font-family: Comfortaa; letter-spacing: 2px;"> Patient ID: </td>
           <td><input type = "text" name = "pid" size = "10" /></td>
         </tr>
         <tr>
           <td style="font-size: 150%; font-family: Comfortaa; letter-spacing: 2px;"> COVID: </td>
           <td><input type = "text" name = "covid" size = "10" /></td>
         </tr>
         <tr>
           <td style="font-size: 150%; font-family: Comfortaa; letter-spacing: 2px;"> Admit Date: </td>
           <td><input type = "text" name = "admitted" size = "10" /></td>
         </tr>
         <tr>
           <td style="font-size: 150%; font-family: Comfortaa; letter-spacing: 2px;"> Designated Doctor ID: </td>
           <td><input type = "text" name = "did" size = "10" /></td>
         </tr>
         <tr>
           <td style="font-size: 150%; font-family: Comfortaa; letter-spacing: 2px;"></td>
