...
<head>
  ...
  <form id = "login" action = "http://localhost/bill_answer.php" method = "post">
    <div class = "usualDiv">
      <table style="margin-top:50px;">
          <tr>
            <td> Bill ID: </td>
            <td><input type = "text" name = "bid" size = "10" /></td>
          </tr>
          <tr>
           <td> Patient ID: </td>
         ...
         <tr>
           <td> Room_bill: </td>
           <td><input type = "text" name = "room_bill" size = "10" /></td>
         </tr>
         <tr>
          <td> Doctor Bill: </td>
          <td><input type = "text" name = "doctor_bill" size = "10" /></td>
        </tr>
        <tr>
          <td>Medical Bill: </td>
          <td><input type = "text" name = "medbill" size = "10" /></td>
        </tr>
       <tr>
         <td> Paid: </td>
         <td><input type = "text" name = "paid" size = "10" /></td>
       </tr>
         <tr>
           <td></td>
