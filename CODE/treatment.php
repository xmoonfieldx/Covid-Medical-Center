...
<head>
  ...
  <link rel="stylesheet" href="homepages.css">
    ...
    if (str.length == 0) {
      ...
      xmlhttp.open("GET", "getyay.php?q="+str, true);
      xmlhttp.send();
      }
    }
    </script>
...
<body>
  ...
  <form id = "login" action = "http://localhost/treatment_answer.php" method = "post">
    <div class = "usualDiv">
      <table style="margin-top:72px;">
         <tr>
           <td> Patient ID: </td>
         ...
         <tr>
           ...
           <td><input type = "text" name = "ttype" size = "100" id="txt1" onkeyup="showHint(this.value)"/></td>
         </tr>
         <tr>
         ...
         <tr>
           <td> Medbill: </td>
           <td><input type = "text" name = "medbill" size = "6" /></td>
         </tr>
         <tr>
           <td> Result: </td>
           <td><input type = "text" name = "result" size = "30" /></td>
         </tr>
         <tr>
           <td></td>
