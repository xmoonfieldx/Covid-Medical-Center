...
<body>
  ...
  <form action = "http://localhost/view_single_record_answer.php" method = "post">
    <div class = "usualDiv">
      <table style="margin-top:82px;">
         <tr>
           <td style="font-size:150%; letter-spacing: 2px;"> Enter the Patient ID to view the record: </td>
