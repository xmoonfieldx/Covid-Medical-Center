...
<body>
  ...
  <!-- Sidebar -->
  <ul id="sidebar" style="margin-top:-28px; height">
      <pre id="fonter">
      ...
      <li id="add" class="active"><a href="http://localhost/pharmacy.php">Pharmacy          <br /></a></li>
  ...
  <!-- end -->
  <div class="usualDiv" style="margin-top:-180px;">
  <?php
  $conn = mysqli_connect("localhost", "root", "", "COVID_MEDICAL_CENTER");
  $sql = "SELECT Name, Price FROM MEDICINE WHERE Availability=1";
